...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base leading-snug font-semibold text-toss-gray-900 group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-sm text-toss-gray-500", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-xl border-t border-toss-gray-100 bg-toss-gray-50 p-5 group-data-[size=sm]/card:p-4",
        className
      )}
      {...props}
    />
